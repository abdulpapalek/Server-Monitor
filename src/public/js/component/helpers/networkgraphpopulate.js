...
import networkgraphdata from  './../stores/networkstore';
//import Highcharts from 'highcharts';
import ReactHighcharts from 'react-highcharts';
import ReactHighstock from 'react-highcharts/ReactHighstock.src';
import RedrawOnPrint from 'react-highcharts';

export default class NetworkGraphpopulate extends React.Component{
	constructor(props) {
	    super(props);
	    this.state = {
	    	graph:networkgraphdata.getAll(),
	    	val:networkgraphdata.getVal()
	    }
	...
	componentDidMount(){
			...
			//Action Dispatch
			//actions.fetchData();	
			networkgraphdata.on("NETWORK_CHANGE_VALUE",()=>{
				console.log("componentDidMount");
				console.log(networkgraphdata.getVal());
	            x = (new Date()).getTime(), // current time
	            y =  networkgraphdata.getVal();
				setTimeout(function() {

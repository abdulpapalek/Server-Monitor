...
import ramgraphdata from  './../stores/ramstore';
//import Highcharts from 'highcharts';
import ReactHighcharts from 'react-highcharts';
import ReactHighstock from 'react-highcharts/ReactHighstock.src';
import RedrawOnPrint from 'react-highcharts';

export default class RamGraphpopulate extends React.Component{
	constructor(props) {
	    super(props);
	    this.state = {
	    	graph:ramgraphdata.getAll(),
	    	val:ramgraphdata.getVal()
	    }
	...
	componentDidMount(){
			...
			//Action Dispatch
			//actions.fetchData();	
			ramgraphdata.on("RAM_CHANGE_VALUE",()=>{
				console.log("componentDidMount");
				console.log(ramgraphdata.getVal());
	            x = (new Date()).getTime(), // current time
	            y =  ramgraphdata.getVal();
	            setTimeout(function() {
